...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-19--22%3A45%3A30-green.svg?style=flat-square)
...
> 运行分析：从 `9` 个活跃源中抓取 `965` 个节点，耗时 `0.42s`。去重后保留 `824` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇹🇭泰国 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 35 | 228 | 32 | 25 | 16 | 11 | 16 | 4 | 3 | 13 | 1 | 3 | 7 | 3 | 1 | 1 | 1 | 1 | 1 | 7 | 14 | 119 | 9 | 2 | 4 | 2 | 3 | 3 | 1 | 3 | 1 | 1 | 1 | 202 | **824** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `57.77%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `15.13%` |
| 3 | `[长效备份] hysteria2 节点` | **98** 个 | `10.29%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `5.67%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.52%` |
| 6 | `[长效备份] hy2 节点` | **18** 个 | `1.89%` |
| 7 | `📡 shaoyouvip 每日更新` | **18** 个 | `1.89%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.47%` |
| 9 | `📱 Pawdroid 免费节点库` | **13** 个 | `1.37%` |
| **-** | **总计 (包含跨源重合)** | **952** 个 | `100.00%` |
