...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `56.82%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.88%` |
| 3 | `[长效备份] hysteria2 节点` | **89** 个 | `9.19%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **69** 个 | `7.13%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.44%` |
| 6 | `📡 shaoyouvip 每日更新` | **28** 个 | `2.89%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.07%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.45%` |
| 9 | `[长效备份] hy2 节点` | **11** 个 | `1.14%` |
| **-** | **总计 (包含跨源重合)** | **968** 个 | `100.00%` |
