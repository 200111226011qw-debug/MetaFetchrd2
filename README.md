...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-14--08%3A42%3A48-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-948-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-14 08:42:48`
> 运行分析：从 `10` 个活跃源中抓取 `1090` 个节点，耗时 `1.74s`。去重后保留 `948` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 45 | 256 | 33 | 25 | 32 | 20 | 18 | 5 | 3 | 19 | 3 | 4 | 10 | 5 | 1 | 2 | 2 | 2 | 1 | 9 | 13 | 134 | 8 | 3 | 6 | 6 | 1 | 4 | 4 | 1 | 3 | 1 | 1 | 1 | 217 | **948** |
...
| 2 | `[长效备份] hysteria2 节点` | **148** 个 | `13.75%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.38%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.29%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.00%` |
| 6 | `[长效备份] hy2 节点` | **33** 个 | `3.07%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **25** 个 | `2.32%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.30%` |
| 9 | `📱 Pawdroid 免费节点库` | **12** 个 | `1.12%` |
