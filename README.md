...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-14--13%3A24%3A40-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-958-orange.svg?style=flat-square)
...
> 运行分析：从 `10` 个活跃源中抓取 `1118` 个节点，耗时 `2.24s`。去重后保留 `958` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 44 | 258 | 34 | 27 | 30 | 21 | 22 | 7 | 3 | 16 | 3 | 4 | 9 | 5 | 1 | 1 | 2 | 2 | 2 | 1 | 10 | 13 | 125 | 7 | 4 | 10 | 6 | 2 | 5 | 4 | 2 | 2 | 1 | 1 | 1 | 1 | 1 | 220 | **958** |
...
| 2 | `[长效备份] hysteria2 节点` | **148** 个 | `13.41%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.04%` |
| 4 | `📡 shaoyouvip 每日更新` | **95** 个 | `8.61%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `4.71%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.89%` |
| 7 | `[长效备份] hy2 节点` | **33** 个 | `2.99%` |
| 8 | `📱 Pawdroid 免费节点库` | **18** 个 | `1.63%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.27%` |
