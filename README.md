...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-23--10%3A48%3A11-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-23 10:48:11`
> 运行分析：从 `9` 个活跃源中抓取 `1047` 个节点，耗时 `0.36s`。去重后保留 `892` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 35 | 254 | 34 | 25 | 19 | 15 | 13 | 5 | 3 | 21 | 1 | 4 | 7 | 4 | 1 | 1 | 1 | 1 | 1 | 10 | 15 | 134 | 6 | 2 | 9 | 3 | 1 | 4 | 3 | 1 | 3 | 1 | 1 | 2 | 1 | 199 | **892** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.19%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.93%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.67%` |
| 4 | `[长效备份] hysteria2 节点` | **93** 个 | `8.99%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `5.22%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.16%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.93%` |
| 8 | `[长效备份] hy2 节点` | **16** 个 | `1.55%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.35%` |
| **-** | **总计 (包含跨源重合)** | **1034** 个 | `100.00%` |
