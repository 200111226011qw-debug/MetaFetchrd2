...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-17--15%3A58%3A47-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-17 15:58:47`
> 运行分析：从 `10` 个活跃源中抓取 `1078` 个节点，耗时 `4.27s`。去重后保留 `930` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇰🇿哈萨克斯坦 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 13 | 44 | 253 | 36 | 25 | 29 | 24 | 18 | 4 | 4 | 21 | 2 | 4 | 8 | 6 | 1 | 3 | 2 | 1 | 1 | 11 | 14 | 121 | 6 | 2 | 6 | 2 | 2 | 8 | 3 | 1 | 1 | 2 | 1 | 2 | 1 | 1 | 207 | **930** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `51.64%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.52%` |
| 3 | `[长效备份] hysteria2 节点` | **119** 个 | `11.17%` |
| 4 | `📡 shaoyouvip 每日更新` | **90** 个 | `8.45%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `5.07%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.04%` |
| 7 | `[长效备份] hy2 节点` | **24** 个 | `2.25%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.88%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.31%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.66%` |
| **-** | **总计 (包含跨源重合)** | **1065** 个 | `100.00%` |
