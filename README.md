...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-18--20%3A22%3A53-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-18 20:22:53`
> 运行分析：从 `9` 个活跃源中抓取 `983` 个节点，耗时 `0.48s`。去重后保留 `878` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 13 | 37 | 267 | 30 | 26 | 27 | 16 | 14 | 5 | 3 | 16 | 2 | 4 | 8 | 4 | 1 | 1 | 1 | 1 | 1 | 10 | 6 | 119 | 5 | 2 | 7 | 2 | 1 | 6 | 3 | 1 | 2 | 1 | 2 | 1 | 1 | 192 | **878** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `56.70%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.85%` |
| 3 | `[长效备份] hysteria2 节点` | **101** 个 | `10.41%` |
| 4 | `📡 shaoyouvip 每日更新` | **76** 个 | `7.84%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.43%` |
| 6 | `[长效备份] hy2 节点` | **22** 个 | `2.27%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.06%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.44%` |
| 9 | `⚡ Misaka Chromego 聚合池` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **970** 个 | `100.00%` |
