...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-20--04%3A45%3A20-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-20 04:45:20`
> 运行分析：从 `9` 个活跃源中抓取 `1040` 个节点，耗时 `0.40s`。去重后保留 `889` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 11 | 37 | 242 | 34 | 27 | 23 | 18 | 14 | 4 | 3 | 21 | 2 | 4 | 7 | 5 | 1 | 2 | 1 | 2 | 1 | 9 | 14 | 123 | 6 | 3 | 8 | 5 | 5 | 3 | 1 | 3 | 1 | 1 | 1 | 1 | 205 | **889** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.55%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.02%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.74%` |
| 4 | `[长效备份] hysteria2 节点` | **98** 个 | `9.54%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **50** 个 | `4.87%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.19%` |
| 7 | `[长效备份] hy2 节点` | **17** 个 | `1.66%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.36%` |
| 9 | `📱 Pawdroid 免费节点库` | **11** 个 | `1.07%` |
| **-** | **总计 (包含跨源重合)** | **1027** 个 | `100.00%` |
