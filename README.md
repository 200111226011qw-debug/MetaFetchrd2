...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-17--08%3A52%3A03-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-941-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-17 08:52:03`
> 运行分析：从 `10` 个活跃源中抓取 `1104` 个节点，耗时 `1.81s`。去重后保留 `941` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇰🇿哈萨克斯坦 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 44 | 258 | 34 | 25 | 28 | 17 | 22 | 8 | 3 | 19 | 2 | 4 | 8 | 5 | 1 | 3 | 2 | 1 | 1 | 9 | 13 | 132 | 14 | 3 | 5 | 4 | 1 | 6 | 3 | 1 | 1 | 2 | 1 | 1 | 1 | 1 | 1 | 206 | **941** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `50.41%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.20%` |
| 3 | `[长效备份] hysteria2 节点` | **134** 个 | `12.28%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.17%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.13%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.94%` |
| 7 | `[长效备份] hy2 节点` | **23** 个 | `2.11%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.83%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.28%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.64%` |
| **-** | **总计 (包含跨源重合)** | **1091** 个 | `100.00%` |
