...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-26--10%3A47%3A41-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-26 10:47:41`
> 运行分析：从 `9` 个活跃源中抓取 `1031` 个节点，耗时 `0.39s`。去重后保留 `886` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 12 | 34 | 245 | 29 | 25 | 23 | 20 | 16 | 4 | 3 | 17 | 3 | 4 | 7 | 3 | 1 | 1 | 1 | 1 | 2 | 11 | 7 | 138 | 4 | 4 | 7 | 5 | 3 | 5 | 2 | 1 | 3 | 1 | 1 | 1 | 1 | 200 | **886** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.92%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.12%` |
| 3 | `📡 shaoyouvip 每日更新` | **101** 个 | `9.90%` |
| 4 | `[长效备份] hysteria2 节点` | **90** 个 | `8.82%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **48** 个 | `4.71%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.22%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.96%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.37%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `0.98%` |
| **-** | **总计 (包含跨源重合)** | **1020** 个 | `100.00%` |
